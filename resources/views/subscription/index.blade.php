...
<div class="container">
    ...
    @if($isAdmin)
        <div class="alert alert-success">
            <strong>Administrator Account:</strong> You have unlimited access to all platform features. No subscription limits apply.
        </div>
        <div class="row mb-4">
            <div class="col-md-6">
                <div class="card border-success">
                    <div class="card-body">
                        ...
                        <p class="display-6 text-success">Administrator</p>
            ...
            <div class="col-md-6">
                <div class="card border-success">
                    <div class="card-body">
                        ...
                        <p class="display-6 text-success">Unlimited</p>
                        <p class="text-muted">No restrictions on invoices, countries, or team members</p>
                    </div>
                </div>
            </div>
        </div>
