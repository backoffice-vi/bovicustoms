...
@section('title', 'Add Customs Code - Admin')
...
<div class="container py-4">
    <div class="mb-4">
        ...
        <h1 class="h3">
            <i class="fas fa-plus-circle me-2"></i>Add Customs Code
        </h1>
    </div>
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.customs-codes.store') }}">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="code" id="code" class="form-control @error('code') is-invalid @enderror" 
                                   value="{{ old('code') }}" placeholder="e.g., 0101.21.00" required maxlength="20">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="duty_rate" id="duty_rate" class="form-control @error('duty_rate') is-invalid @enderror" 
                                           value="{{ old('duty_rate') }}" step="0.01" min="0" max="100" required>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="hs_code_version" id="hs_code_version" class="form-control @error('hs_code_version') is-invalid @enderror" 
                                           value="{{ old('hs_code_version') }}" placeholder="e.g., 2022" maxlength="10">
