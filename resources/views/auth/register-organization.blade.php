...
<head>
    ...
    <title>Create Organization - BoVi Customs</title>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="register-card">
                    <h2 class="mb-4">Create Your Organization</h2>
                    <p class="text-muted mb-4">Start your 14-day free trial. No credit card required.</p>
                    ...
                    <form method="POST" action="{{ route('register.organization.post') }}">
                        @csrf
                        
                        <div class="mb-3">
                            <label class="form-label">Organization Name</label>
                            <input type="text" name="organization_name" class="form-control" value="{{ old('organization_name') }}" required autofocus>
                        </div>
